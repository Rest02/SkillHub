    ...
    return (
      <div className="flex flex-col items-center justify-center p-10 text-center bg-white border border-black rounded-lg shadow-md">
        <p className="text-lg text-gray-700 font-semibold mb-4">
          Aún no se han creado valoraciones para tu curso de parte de tus
          alumnos.
        </p>
        <p className="text-sm text-gray-500">
          ¡Sé el primero en recibir una valoración! Tus alumnos podrán compartir
          sus opiniones aquí para ayudarte a mejorar.
        </p>
      </div>
    );
  }
                ...
                <div className="md:flex items-center md:space-x-4 mb-3">
                  <div className="flex items-center space-x-4 md:space-x-2 md:space-x-reverse">
                    ...
                    <time className="text-sm font-medium text-indigo-500 md:w-28">
                      {new Date(valoracion.date).toLocaleDateString()}{" "}
                      {/* Asegúrate de tener una propiedad `date` en las valoraciones */}
                    </time>
                  </div>
                  {/* Title and Stars */}
                  <div className="flex items-center ml-14">
                    ...
                    <div className="flex ml-2">
                      {renderStars(valoracion.score)}{" "}
                      {/* Las estrellas basadas en la valoración */}
                    </div>
                  </div>
                </div>
                {/* Card */}
